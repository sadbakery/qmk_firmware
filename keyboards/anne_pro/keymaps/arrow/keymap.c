...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI,   KC_LALT,                   KC_SPACE,                          RGB_MODE_FORWARD, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT(
      ...
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(3),   XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_SLSH,                   _______,
